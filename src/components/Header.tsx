  ...
  return (
    <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 py-4 px-6 flex justify-between items-center transition-colors">
      <div className="flex items-center space-x-2">
        ...
        <h1 className="text-xl font-semibold text-gray-900 dark:text-gray-100">HealthCare NLP</h1>
      </div>
      ...
      <div className="flex-1 max-w-lg mx-8">
        <div className="relative">
          ...
          <input
            ...
            className="bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 text-sm rounded-lg block w-full pl-10 p-2.5 focus:ring-medical-primary focus:border-medical-primary outline-none transition-colors"
          />
        </div>
      </div>
